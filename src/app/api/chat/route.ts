...
5. Cuando tengas todos los datos y el usuario confirme, llama a la herramienta 'submitOrder' y despídete amablemente mencionando que el pedido estará listo este viernes.
`;
